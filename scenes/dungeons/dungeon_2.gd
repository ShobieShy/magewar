## Dungeon 2 - The Forgotten Caves
## Uses the dungeon template system for scaled difficulty and content
class_name Dungeon2
extends Node3D
...
var dungeon_id: String = "dungeon_2"
var dungeon_name: String = "Forgotten Caves"
var difficulty: int = 2
var max_enemies: int = 15  # Scaled from template
...
func collect_spawn_points() -> void:
	...
	# Add fallback predefined spawn positions
	if enemy_spawn_points.is_empty():
		enemy_spawn_points.append_array([
			Vector3(-15, 0, 15),  # Cave entrance
			Vector3(-17, 0, 17),  # Cave entrance secondary
			Vector3(15, 0, 15),   # Crystal chamber
			Vector3(17, 0, 13),   # Crystal chamber secondary
			Vector3(0, 0, 15),    # Main tunnel
			Vector3(0, 0, 20),    # Main tunnel secondary
			Vector3(-10, 0, 25),  # Side cavern
			Vector3(10, 0, 25),   # Side cavern secondary
		])
...
func spawn_initial_enemies() -> void:
	...
	# Pre-placed enemies (scaled up from dungeon 1)
...
func track_existing_enemies() -> void:
	...
	# Dungeon 2 has more challenging pre-placed enemies
	var enemy_nodes = [
		$EnemyRoom1/Enemy1,
		$EnemyRoom1/Enemy2,
		$EnemyRoom2/Enemy1,
	...
	# Connect to death signals and apply scaling
...
func spawn_random_enemies(count: int) -> void:
	...
	for i in range(min(count, enemy_spawn_points.size())):
		...
		# Select enemy type based on dungeon 2 pool
...
func spawn_boss() -> void:
	"""Spawn the dungeon 2 boss - Crystal Golem"""
	print("Spawning Crystal Golem Boss!")

	var boss = $BossArea/CrystalGolem
	if boss:
		enemies.append(boss)
		current_enemies += 1
...
func complete_dungeon() -> void:
	...
	# Award completion rewards (scaled)
...
func award_completion_rewards() -> void:
	"""Give players scaled completion rewards"""
	# XP reward (scaled)
...
func create_completion_effect() -> void:
	...
	# Spawn crystal particle effect for dungeon 2 theme
	...
	material.color = Color(0.2, 0.8, 1.0)  # Crystal blue
